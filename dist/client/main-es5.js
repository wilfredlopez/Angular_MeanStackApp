...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard.prototype.canActivate = function (route, state) {
        var auth = this.authService.getIfAuth();
        if (!auth) {
...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        this.authStatusListenter = this.authService.authStatusListenter.subscribe(function (authStatus) {
            _this.userAthenticated = authStatus;
            _this.userInfo = _this.authService.getUserInfo();
        });
    };
...
var PostCreateComponent = /** @class */ (function () {
    ...
    PostCreateComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (paramMap) {
            if (paramMap.has("id")) {
                _this.mode = "edit";
                _this.postId = paramMap.get("id");
                _this.postService.getOnePost(_this.postId).subscribe(function (data) {
                    _this.isLoading = false;
                    _this.post = {
                        id: data.post._id,
...
var PostListComponent = /** @class */ (function () {
    ...
    PostListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.userAthenticated = this.authService.getIfAuth();
        this.authServiceSub = this.authService.authStatusListenter.subscribe(function (authStatus) {
            _this.userAthenticated = authStatus;
            _this.userInfo = _this.authService.getUserInfo();
        });
        this.userInfo = this.authService.getUserInfo();
...
var serverURL = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].BACKEND_URL;
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.createUser = function (email, password, username) {
        var _this = this;
        var requestData = { email: email, password: password, username: username };
        this.http
            ...
            console.warn(error);
            _this.authStatusListenter.next(false);
        });
    };
    ...
    AuthService.prototype.loginUser = function (email, password) {
        ...
        this.http
            ...
            if (res.token) {
                _this.token = res.token;
                _this.expiresInDuration = res.expiresIn;
                _this.setAuthTimer(_this.expiresInDuration);
                _this.isAuthenticatd = true;
                _this.userInfo = {
                    userId: res.userId,
                    username: res.username
                };
                var now = new Date();
                var expirationTime = new Date(now.getTime() + _this.expiresInDuration * 1000);
                _this.saveAuthData(_this.token, expirationTime, res.userId, res.username);
                _this.authStatusListenter.next(true);
    ...
    AuthService.prototype.autoAuthUser = function () {
        ...
        var now = new Date();
        var expiresIn = authInformation.expiresIn.getTime() - now.getTime();
        if (expiresIn > 0) {
    ...
    AuthService.prototype.getLocalAuthData = function () {
        ...
        var expiraton = localStorage.getItem("expiration");
    ...
    AuthService.prototype.getIfAuth = function () {
...
var serverURL = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].BACKEND_URL;
var PostService = /** @class */ (function () {
    ...
    PostService.prototype.getPosts = function (postsPerPage, currentPage) {
        var _this = this;
        if (postsPerPage === void 0) { postsPerPage = 5; }
    ...
    PostService.prototype.updatePost = function (id, post) {
        ...
        this.http
            ...
            .subscribe(function (data) {
            var postIndex = _this.posts.findIndex(function (p) { return p.id === id; });
    ...
    PostService.prototype.getPostListener = function () {
